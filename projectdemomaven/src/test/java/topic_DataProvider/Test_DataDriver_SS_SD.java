...
public class Test_DataDriver_SS_SD {
	public WebDriver driver;
	  ...
	  public void getTestResult(ITestResult testResult) 
	  {
		 ...
		 System.out.println("TestCase Result: "+testResult.getStatus());//result as the integer value 1-----passed and 2-----failed
		 ...
		 else
		 {
			 ...
			 try {
				FileUtils.copyFile(outfile,new File("C:\\Automation\\projectdemomaven\\src\\test\\resources\\allResourceFile"+testResult.getParameters()[0]+"Defect.jpeg"));
			} catch (IOException e) {
